...
typedef nlmulret_nlboolean_nlint64_nlfloat64 (*function_4ujZU2iQ6roU5kmF)(nelua_vector_float64__ptr, int64_t);
...
typedef struct nlmulret_function_4ujZU2iQ6roU5kmF_nelua_vector_float64__ptr_nlint64 {
  function_4ujZU2iQ6roU5kmF r1;
  nelua_vector_float64__ptr r2;
  int64_t r3;
} nlmulret_function_4ujZU2iQ6roU5kmF_nelua_vector_float64__ptr_nlint64;
static NELUA_INLINE nlmulret_function_4ujZU2iQ6roU5kmF_nelua_vector_float64__ptr_nlint64 nelua_ipairs_1(nelua_vector_float64__ptr a);
...
typedef nlmulret_nlboolean_nlpointer_nelua_GCItem_ptr (*function_482FB8BQ6U4PQ7taF)(nelua_hashmap_iteratorT_ptr, void*);
...
typedef struct nlmulret_function_482FB8BQ6U4PQ7taF_nelua_hashmap_iteratorT_nlpointer {
  function_482FB8BQ6U4PQ7taF r1;
  nelua_hashmap_iteratorT r2;
  void* r3;
} nlmulret_function_482FB8BQ6U4PQ7taF_nelua_hashmap_iteratorT_nlpointer;
static NELUA_INLINE nlmulret_function_482FB8BQ6U4PQ7taF_nelua_hashmap_iteratorT_nlpointer nelua_mpairs_1(nelua_hashmap_pointer__GCItem__ptr a);
...
typedef nlmulret_nlboolean_nlisize_entropy_scene_mesh_Mesh_ptr (*function_3GJ1mpt5YEiuRg5QG)(entropy_world_Storage_Mesh__ptr, intptr_t);
...
typedef struct nlmulret_function_3GJ1mpt5YEiuRg5QG_entropy_world_Storage_Mesh__ptr_nlisize {
  function_3GJ1mpt5YEiuRg5QG r1;
  entropy_world_Storage_Mesh__ptr r2;
  intptr_t r3;
} nlmulret_function_3GJ1mpt5YEiuRg5QG_entropy_world_Storage_Mesh__ptr_nlisize;
static NELUA_INLINE nlmulret_function_3GJ1mpt5YEiuRg5QG_entropy_world_Storage_Mesh__ptr_nlisize nelua_mpairs_2(entropy_world_Storage_Mesh__ptr a);
...
typedef nlmulret_nlboolean_nlisize_main_Entity_ptr (*function_5WeuUYGDC1RF4e9JH)(entropy_world_Storage_Entity__ptr, intptr_t);
...
typedef struct nlmulret_function_5WeuUYGDC1RF4e9JH_entropy_world_Storage_Entity__ptr_nlisize {
  function_5WeuUYGDC1RF4e9JH r1;
  entropy_world_Storage_Entity__ptr r2;
  intptr_t r3;
} nlmulret_function_5WeuUYGDC1RF4e9JH_entropy_world_Storage_Entity__ptr_nlisize;
static NELUA_INLINE nlmulret_function_5WeuUYGDC1RF4e9JH_entropy_world_Storage_Entity__ptr_nlisize nelua_mpairs_3(entropy_world_Storage_Entity__ptr a);
...
static NELUA_INLINE nlmulret_function_482FB8BQ6U4PQ7taF_nelua_hashmap_iteratorT_nlpointer nelua_hashmap_pointer__GCItem____mpairs(nelua_hashmap_pointer__GCItem__ptr self);
...
typedef void (*function_f3DKucyg4xbLySJr)(nelua_GC_ptr);
...
typedef void (*function_2vCUW1a54xBcDXycz)(void*, void*);
static bool nelua_GC_step(nelua_GC_ptr self);
static void nelua_GC_register(nelua_GC_ptr self, void* ptr, uintptr_t size, uintptr_t flags, function_2vCUW1a54xBcDXycz finalizer, void* userdata);
...
typedef int (*function_2pBzfm76Zt38zftxu)(int, nlcstring_ptr);
...
typedef int (*function_4ZS7EgdsBbbg7Uzdz)(FILE_ptr);
struct nelua_FStream {
  FILE_ptr fp;
  function_4ZS7EgdsBbbg7Uzdz closef;
};
...
static NELUA_NOINLINE WGPUShaderModuleWGSLDescriptor_ptr nelua_GCAllocator_new_3(nelua_GCAllocator_ptr self, nlniltype what, nlniltype size, nlniltype flags);
...
static void nelua_GCAllocator_delete_2(nelua_GCAllocator_ptr self, nelua_FStream_ptr v);
...
static nlstring nelua_nlstring___concat_4(entropy_math_vec4_Vec4 a, nlstring b);
...
static nlstring nelua_tostring_4(entropy_math_vec4_Vec4 x);
...
static NELUA_INLINE nlmulret_function_5WeuUYGDC1RF4e9JH_entropy_world_Storage_Entity__ptr_nlisize entropy_world_Storage_Entity____mpairs(entropy_world_Storage_Entity__ptr self);
...
static NELUA_INLINE nlmulret_function_3GJ1mpt5YEiuRg5QG_entropy_world_Storage_Mesh__ptr_nlisize entropy_world_Storage_Mesh____mpairs(entropy_world_Storage_Mesh__ptr self);
...
typedef entropy_math_vec4_Vec4* entropy_math_vec4_Vec4_ptr;
static nlstring entropy_math_vec4_Vec4___tostring(entropy_math_vec4_Vec4_ptr self);
...
static nlstring entropy_math_mat4_Mat4___tostring(entropy_math_mat4_Mat4_ptr self);
...
static entropy_math_mat4_Mat4 main_a;
static entropy_math_mat4_Mat4 main_b;
static entropy_math_mat4_Mat4 main_c;
...
typedef void (*function_3zFT2VCA5DfxugTd)(void*, uint32_t, uint32_t);
...
struct entropy_render_glfw_context_GLFWContext {
  ...
  bool vsync;
  void* user_pointer;
  function_3zFT2VCA5DfxugTd resize_callback;
...
NELUA_STATIC_ASSERT(sizeof(entropy_render_glfw_context_GLFWContext) == 80 && NELUA_ALIGNOF(entropy_render_glfw_context_GLFWContext) == 8, "Nelua and C disagree on type size or align");
...
static NELUA_INLINE void entropy_render_glfw_context_GLFWContext_poll_events(entropy_render_glfw_context_GLFWContext_ptr self);
...
typedef struct record_Zrbw5J37uisrJoqq record_Zrbw5J37uisrJoqq;
struct record_Zrbw5J37uisrJoqq {
  WGPUTextureFormat format;
  uint32_t width;
  uint32_t height;
};
NELUA_STATIC_ASSERT(sizeof(record_Zrbw5J37uisrJoqq) == 12 && NELUA_ALIGNOF(record_Zrbw5J37uisrJoqq) == 4, "Nelua and C disagree on type size or align");
...
struct entropy_render_renderer_RendererImplT {
  ...
  record_Zrbw5J37uisrJoqq target_config;
...
typedef int (*function_2jryoGdNYpmXwuUqi)(FILE_ptr);
static nelua_filestream nelua_filestream__fromfp(FILE_ptr fp, function_2jryoGdNYpmXwuUqi closef);
...
static entropy_render_shader_Shader entropy_render_shader_Shader_load_from_file(nlstring name, nlstring path);
...
typedef nlmulret_nlboolean_nlstring (*function_3za43wtfzNaFXZkKo)(nelua_LinesState, nlstring);
typedef struct nlmulret_function_3za43wtfzNaFXZkKo_nelua_LinesState_nlstring_nelua_filestream {
  function_3za43wtfzNaFXZkKo r1;
  nelua_LinesState r2;
  nlstring r3;
  nelua_filestream r4;
} nlmulret_function_3za43wtfzNaFXZkKo_nelua_LinesState_nlstring_nelua_filestream;
static nlmulret_function_3za43wtfzNaFXZkKo_nelua_LinesState_nlstring_nelua_filestream nelua_io_lines_1(nlstring filename, nlniltype fmt);
...
static uintptr_t main_mesh_idx;
...
nlmulret_function_4ujZU2iQ6roU5kmF_nelua_vector_float64__ptr_nlint64 nelua_ipairs_1(nelua_vector_float64__ptr a) {
  return (nlmulret_function_4ujZU2iQ6roU5kmF_nelua_vector_float64__ptr_nlint64){nelua_ipairs_next, a, -1};
}
nlmulret_function_482FB8BQ6U4PQ7taF_nelua_hashmap_iteratorT_nlpointer nelua_mpairs_1(nelua_hashmap_pointer__GCItem__ptr a) {
  nlmulret_function_482FB8BQ6U4PQ7taF_nelua_hashmap_iteratorT_nlpointer _ret_1 = nelua_hashmap_pointer__GCItem____mpairs(a);
  return (nlmulret_function_482FB8BQ6U4PQ7taF_nelua_hashmap_iteratorT_nlpointer){_ret_1.r1, _ret_1.r2, _ret_1.r3};
}
nlmulret_function_3GJ1mpt5YEiuRg5QG_entropy_world_Storage_Mesh__ptr_nlisize nelua_mpairs_2(entropy_world_Storage_Mesh__ptr a) {
  nlmulret_function_3GJ1mpt5YEiuRg5QG_entropy_world_Storage_Mesh__ptr_nlisize _ret_1 = entropy_world_Storage_Mesh____mpairs(a);
  return (nlmulret_function_3GJ1mpt5YEiuRg5QG_entropy_world_Storage_Mesh__ptr_nlisize){_ret_1.r1, _ret_1.r2, _ret_1.r3};
}
nlmulret_function_5WeuUYGDC1RF4e9JH_entropy_world_Storage_Entity__ptr_nlisize nelua_mpairs_3(entropy_world_Storage_Entity__ptr a) {
  nlmulret_function_5WeuUYGDC1RF4e9JH_entropy_world_Storage_Entity__ptr_nlisize _ret_1 = entropy_world_Storage_Entity____mpairs(a);
  return (nlmulret_function_5WeuUYGDC1RF4e9JH_entropy_world_Storage_Entity__ptr_nlisize){_ret_1.r1, _ret_1.r2, _ret_1.r3};
}
void nelua_assert_line_1(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/y9vnyq9wkbv0z22dgkjkzj09ss9l6wyk-nelua-9de66a3/lib/nelua/lib/memory.nelua:27:14: runtime error: ", 107, false);
...
void nelua_assert_line_2(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/y9vnyq9wkbv0z22dgkjkzj09ss9l6wyk-nelua-9de66a3/lib/nelua/lib/memory.nelua:60:9: runtime error: ", 106, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
void nelua_assert_line_3(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/y9vnyq9wkbv0z22dgkjkzj09ss9l6wyk-nelua-9de66a3/lib/nelua/lib/memory.nelua:76:11: runtime error: ", 107, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
void nelua_assert_line_4(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/y9vnyq9wkbv0z22dgkjkzj09ss9l6wyk-nelua-9de66a3/lib/nelua/lib/memory.nelua:89:11: runtime error: ", 107, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
    nelua_write_stderr("\n  check(a and b, 'invalid pointer')\n          ^~~~~\n", 53, true);
    nelua_abort();
  }
...
void nelua_assert_line_5(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/y9vnyq9wkbv0z22dgkjkzj09ss9l6wyk-nelua-9de66a3/lib/nelua/lib/memory.nelua:102:9: runtime error: ", 107, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
void nelua_assert_line_6(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/y9vnyq9wkbv0z22dgkjkzj09ss9l6wyk-nelua-9de66a3/lib/nelua/lib/memory.nelua:116:20: runtime error: ", 108, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
void nelua_assert_line_7(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/y9vnyq9wkbv0z22dgkjkzj09ss9l6wyk-nelua-9de66a3/lib/nelua/lib/span.nelua:90:13: runtime error: ", 105, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
void nelua_assert_line_21(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/y9vnyq9wkbv0z22dgkjkzj09ss9l6wyk-nelua-9de66a3/lib/nelua/lib/sequence.nelua:147:17: runtime error: ", 110, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
void nelua_assert_line_22(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/y9vnyq9wkbv0z22dgkjkzj09ss9l6wyk-nelua-9de66a3/lib/nelua/lib/sequence.nelua:255:18: runtime error: ", 110, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
void nelua_assert_line_23(bool cond) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/y9vnyq9wkbv0z22dgkjkzj09ss9l6wyk-nelua-9de66a3/lib/nelua/lib/hashmap.nelua:212:15: runtime error: assertion failed!\n      check(j == self.size)\n              ^~~~~~~~~~~~\n",  182, true);
    nelua_abort();
  }
}
...
void nelua_assert_line_24(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/y9vnyq9wkbv0z22dgkjkzj09ss9l6wyk-nelua-9de66a3/lib/nelua/lib/hashmap.nelua:268:24: runtime error: ", 109, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
nlmulret_function_482FB8BQ6U4PQ7taF_nelua_hashmap_iteratorT_nlpointer nelua_hashmap_pointer__GCItem____mpairs(nelua_hashmap_pointer__GCItem__ptr self) {
  return (nlmulret_function_482FB8BQ6U4PQ7taF_nelua_hashmap_iteratorT_nlpointer){nelua_hashmap_iteratorT_mnext, (nelua_hashmap_iteratorT){.container = self, .index = 0xffffffffffffffffULL}, NULL};
}
...
void nelua_assert_line_25(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/y9vnyq9wkbv0z22dgkjkzj09ss9l6wyk-nelua-9de66a3/lib/nelua/lib/vector.nelua:120:17: runtime error: ", 108, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
void nelua_assert_line_26(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/y9vnyq9wkbv0z22dgkjkzj09ss9l6wyk-nelua-9de66a3/lib/nelua/lib/vector.nelua:219:15: runtime error: ", 108, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
void nelua_assert_line_28(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/y9vnyq9wkbv0z22dgkjkzj09ss9l6wyk-nelua-9de66a3/lib/nelua/lib/vector.nelua:140:21: runtime error: ", 108, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
void nelua_assert_line_46(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/y9vnyq9wkbv0z22dgkjkzj09ss9l6wyk-nelua-9de66a3/lib/nelua/lib/allocators/gc.nelua:127:19: runtime error: ", 115, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
void nelua_GC_unmarkall(nelua_GC_ptr self) {
  {
    nlmulret_function_482FB8BQ6U4PQ7taF_nelua_hashmap_iteratorT_nlpointer _asgnret_1 = nelua_mpairs_1((&self->items));
    function_482FB8BQ6U4PQ7taF __fornext = _asgnret_1.r1;
...
void nelua_GC_mark(nelua_GC_ptr self) {
  ...
  if((self->stackbottom != 0)) {
    volatile function_f3DKucyg4xbLySJr markstack = nelua_GC_markstack;
    markstack(self);
  }
}
void nelua_assert_line_47(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/y9vnyq9wkbv0z22dgkjkzj09ss9l6wyk-nelua-9de66a3/lib/nelua/lib/allocators/gc.nelua:261:20: runtime error: ", 115, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
void nelua_assert_line_48(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/y9vnyq9wkbv0z22dgkjkzj09ss9l6wyk-nelua-9de66a3/lib/nelua/lib/allocators/gc.nelua:277:22: runtime error: ", 115, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
void nelua_GC_registerroots(nelua_GC_ptr self) {
  nelua_GC_register((&nelua_gc), (void*)(&main_world), 1080U, 131072U, (function_2vCUW1a54xBcDXycz)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&main_positions), 8U, 131072U, (function_2vCUW1a54xBcDXycz)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&main_velocities), 8U, 131072U, (function_2vCUW1a54xBcDXycz)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&main_entities), 8U, 131072U, (function_2vCUW1a54xBcDXycz)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&main_times), 24U, 131072U, (function_2vCUW1a54xBcDXycz)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&main_context), 80U, 131072U, (function_2vCUW1a54xBcDXycz)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&main_renderer), 64U, 131072U, (function_2vCUW1a54xBcDXycz)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&main_cameras), 8U, 131072U, (function_2vCUW1a54xBcDXycz)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&main_meshes), 8U, 131072U, (function_2vCUW1a54xBcDXycz)NULL, (void*)NULL);
}
...
void nelua_assert_line_49(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/y9vnyq9wkbv0z22dgkjkzj09ss9l6wyk-nelua-9de66a3/lib/nelua/lib/allocators/gc.nelua:382:18: runtime error: ", 115, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
    nelua_write_stderr("\n  check(item.ptr == nilptr, 'cannot register pointer twice')\n                 ^~~~~~~~~\n", 89, true);
    nelua_abort();
  }
}
void nelua_GC_register(nelua_GC_ptr self, void* ptr, uintptr_t size, uintptr_t flags, function_2vCUW1a54xBcDXycz finalizer, void* userdata) {
  if(NELUA_UNLIKELY((!(ptr != NULL)))) {
    return;
  }
...
void nelua_assert_line_50(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/y9vnyq9wkbv0z22dgkjkzj09ss9l6wyk-nelua-9de66a3/lib/nelua/lib/allocators/gc.nelua:409:47: runtime error: ", 115, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
void nelua_assert_line_51(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/y9vnyq9wkbv0z22dgkjkzj09ss9l6wyk-nelua-9de66a3/lib/nelua/lib/allocators/gc.nelua:413:17: runtime error: ", 115, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
void nelua_assert_line_52(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/y9vnyq9wkbv0z22dgkjkzj09ss9l6wyk-nelua-9de66a3/lib/nelua/lib/allocators/gc.nelua:428:21: runtime error: ", 115, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
int main(int argc, nlcstring_ptr argv) {
  ...
  volatile function_2pBzfm76Zt38zftxu inner_main = nelua_main;
...
void nelua_assert_line_53(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/y9vnyq9wkbv0z22dgkjkzj09ss9l6wyk-nelua-9de66a3/lib/nelua/lib/allocators/gc.nelua:759:16: runtime error: ", 115, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
void nelua_assert_line_54(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/y9vnyq9wkbv0z22dgkjkzj09ss9l6wyk-nelua-9de66a3/lib/nelua/lib/allocators/gc.nelua:762:16: runtime error: ", 115, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
    nelua_write_stderr("\n    assert(ptr ~= nilptr, 'out of memory')\n               ^~~~~~~~~\n", 69, true);
    nelua_abort();
  }
...
nelua_FStream_ptr nelua_GCAllocator_new_2(nelua_GCAllocator_ptr self, nelua_FStream what, nlniltype size, nlniltype flags) {
  ...
  nelua_assert_line_54((ptr != ((nelua_FStream_ptr)NULL)), ((nlstring){(uint8_t*)"out of memory", 13}));
...
WGPUShaderModuleWGSLDescriptor_ptr nelua_GCAllocator_new_3(nelua_GCAllocator_ptr self, nlniltype what, nlniltype size, nlniltype flags) {
  nelua_GCFinalizerCallback finalizer = (nelua_GCFinalizerCallback)NULL;
  ...
  nelua_assert_line_55((ptr != ((WGPUShaderModuleWGSLDescriptor_ptr)NULL)), ((nlstring){(uint8_t*)"out of memory", 13}));
  return ptr;
}
...
void nelua_GCAllocator_delete_2(nelua_GCAllocator_ptr self, nelua_FStream_ptr v) {
...
void nelua_assert_line_56(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/y9vnyq9wkbv0z22dgkjkzj09ss9l6wyk-nelua-9de66a3/lib/nelua/lib/detail/strconv.nelua:38:20: runtime error: ", 115, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
nlmulret_nlboolean_nlint64 nelua_strconv_1_str2int(nlstring s, uint64_t base) {
  ...
  nelua_assert_line_56(((base >= 2) && (base <= 36)), ((nlstring){(uint8_t*)"base out of range", 17}));
  uint64_t n = 0U;
  while((pos < s.size)) {
...
void nelua_assert_line_57(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/y9vnyq9wkbv0z22dgkjkzj09ss9l6wyk-nelua-9de66a3/lib/nelua/lib/stringbuilder.nelua:150:19: runtime error: ", 115, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
void nelua_stringbuilderT_commit(nelua_stringbuilderT_ptr self, uintptr_t n) {
  ...
  nelua_assert_line_57((newsize <= self->data.size), ((nlstring){(uint8_t*)"not enough space in string buffer", 33}));
  self->size = newsize;
}
...
void nelua_assert_line_58(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/y9vnyq9wkbv0z22dgkjkzj09ss9l6wyk-nelua-9de66a3/lib/nelua/lib/string.nelua:35:14: runtime error: ", 107, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
nlstring nelua_nlstring_create(uintptr_t size) {
  nelua_assert_line_58((size > 0), ((nlstring){(uint8_t*)"attempt to create an empty string", 33}));
...
nlstring nelua_nlstring___concat_4(entropy_math_vec4_Vec4 a, nlstring b) {
  nlstring a_3 = nelua_tostring_4(a);
  if((a_3.size == 0)) {
    nlstring _ret_1 = nelua_nlstring_copy(b);
    { /* defer */
...
nlstring nelua_nlstring___concat_8(WGPULogLevel a, nlstring b) {
  nlstring a_4 = nelua_tostring_6(a);
  if((a_4.size == 0)) {
    nlstring _ret_1 = nelua_nlstring_copy(b);
    { /* defer */
      nelua_nlstring_destroy((&a_4));
    }
    return _ret_1;
  } else if((b.size == 0)) {
    nlstring _ret_2 = nelua_nlstring_copy(a_4);
    { /* defer */
      nelua_nlstring_destroy((&a_4));
    }
    return _ret_2;
  }
  nlstring s = nelua_nlstring_create((a_4.size + b.size));
  nelua_memory_copy((void*)s.data, (void*)a_4.data, a_4.size);
  nelua_memory_copy((void*)(&s.data[a_4.size]), (void*)b.data, b.size);
  { /* defer */
    nelua_nlstring_destroy((&a_4));
  }
  return s;
...
void nelua_assert_line_59(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/y9vnyq9wkbv0z22dgkjkzj09ss9l6wyk-nelua-9de66a3/lib/nelua/lib/detail/strpatt.nelua:135:16: runtime error: ", 116, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
void nelua_assert_line_60(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/y9vnyq9wkbv0z22dgkjkzj09ss9l6wyk-nelua-9de66a3/lib/nelua/lib/detail/strpatt.nelua:142:18: runtime error: ", 116, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
intptr_t nelua_match_class_end(nelua_StrPatt_1_ptr ms_1, intptr_t p_1) {
  ...
  switch(c) {
    case 37U: {
      nelua_assert_line_59((p_1 != nelua_nlstring___len(ms_1->pattern)), ((nlstring){(uint8_t*)"malformed pattern (ends with '%')", 33}));
      p_1 = (p_1 + 1);
      break;
    }
    case 91U: {
      ...
      }
      {
        bool _repeat_stop;
        do {
          nelua_assert_line_60((p_1 != nelua_nlstring___len(ms_1->pattern)), ((nlstring){(uint8_t*)"malformed pattern (missing ']')", 31}));
...
void nelua_assert_line_61(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/y9vnyq9wkbv0z22dgkjkzj09ss9l6wyk-nelua-9de66a3/lib/nelua/lib/detail/strpatt.nelua:196:14: runtime error: ", 116, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
intptr_t nelua_match_balance(nelua_StrPatt_1_ptr ms_4, intptr_t s_2, intptr_t p_4) {
  nelua_assert_line_61((p_4 < (nelua_nlstring___len(ms_4->pattern) - 1)), ((nlstring){(uint8_t*)"malformed pattern (missing arguments to '%b')", 45}));
...
void nelua_assert_line_62(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/y9vnyq9wkbv0z22dgkjkzj09ss9l6wyk-nelua-9de66a3/lib/nelua/lib/detail/strpatt.nelua:251:24: runtime error: ", 116, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
intptr_t nelua_match_start_capture(nelua_StrPatt_1_ptr ms_7, intptr_t s_5, intptr_t p_7, intptr_t what) {
  ...
  nelua_assert_line_62((numcaptures < 32), ((nlstring){(uint8_t*)"too many captures", 17}));
...
void nelua_assert_line_63(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/y9vnyq9wkbv0z22dgkjkzj09ss9l6wyk-nelua-9de66a3/lib/nelua/lib/detail/strpatt.nelua:271:14: runtime error: ", 116, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
intptr_t nelua_match_end_capture(nelua_StrPatt_1_ptr ms_8, intptr_t s_6, intptr_t p_8) {
  ...
  nelua_assert_line_63((l != -1), ((nlstring){(uint8_t*)"invalid pattern capture", 23}));
...
void nelua_assert_line_64(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/y9vnyq9wkbv0z22dgkjkzj09ss9l6wyk-nelua-9de66a3/lib/nelua/lib/detail/strpatt.nelua:282:42: runtime error: ", 116, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
intptr_t nelua_match_capture(nelua_StrPatt_1_ptr ms_9, intptr_t s_7, intptr_t l) {
  l = (intptr_t)(l - 49U);
  nelua_assert_line_64((((l >= 0) && (l < ms_9->numcaptures)) && (ms_9->capture[nelua_assert_bounds_nlisize(l, 32)].len != -1)), ((nlstring){(uint8_t*)"invalid capture index", 21}));
...
void nelua_assert_line_65(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/y9vnyq9wkbv0z22dgkjkzj09ss9l6wyk-nelua-9de66a3/lib/nelua/lib/detail/strpatt.nelua:292:19: runtime error: ", 116, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
void nelua_assert_line_66(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/y9vnyq9wkbv0z22dgkjkzj09ss9l6wyk-nelua-9de66a3/lib/nelua/lib/detail/strpatt.nelua:324:35: runtime error: ", 116, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
intptr_t nelua_StrPatt_1__match(nelua_StrPatt_1_ptr ms, intptr_t s, intptr_t p) {
  ms->depth = (ms->depth - 1);
  nelua_assert_line_65((ms->depth > 0), ((nlstring){(uint8_t*)"pattern too complex", 19}));
    ...
    switch(ms->pattern.data[p]) {
      ...
      case 37U: {
        switch(ms->pattern.data[(p + 1)]) {
          ...
          case 102U: {
            p = (p + 2);
            nelua_assert_line_66((ms->pattern.data[p] == 91U), ((nlstring){(uint8_t*)"missing '[' after '%f' in pattern", 33}));
...
void nelua_assert_line_67(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/y9vnyq9wkbv0z22dgkjkzj09ss9l6wyk-nelua-9de66a3/lib/nelua/lib/string.nelua:814:16: runtime error: ", 108, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
    nelua_write_stderr("\n        assert(ok, capstr)\n               ^~\n", 46, true);
    nelua_abort();
  }
...
void nelua_assert_line_68(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/y9vnyq9wkbv0z22dgkjkzj09ss9l6wyk-nelua-9de66a3/lib/nelua/lib/string.nelua:815:16: runtime error: ", 108, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
  ...
  if((endpos != -1)) {
    if((ms.numcaptures > 0)) {
      ...
      for(intptr_t i = 0, _end = ms.numcaptures; i < _end; i += 1) {
        ...
        nelua_assert_line_67(ok, capstr);
        nelua_assert_line_68((!nelua_StrPattCapture_is_position((&capture))), ((nlstring){(uint8_t*)"position capture not supported yet", 34}));
...
nlstring nelua_tostring_4(entropy_math_vec4_Vec4 x) {
  return entropy_math_vec4_Vec4___tostring((&x));
}
...
void nelua_assert_line_69(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/y9vnyq9wkbv0z22dgkjkzj09ss9l6wyk-nelua-9de66a3/lib/nelua/lib/string.nelua:986:12: runtime error: ", 108, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
double nelua_tonumber_1(nlstring x, nlniltype base) {
  ...
  nelua_assert_line_69(ok, ((nlstring){(uint8_t*)"malformed number", 16}));
  return n;
}
void nelua_assert_line_70(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/y9vnyq9wkbv0z22dgkjkzj09ss9l6wyk-nelua-9de66a3/lib/nelua/lib/string.nelua:1002:12: runtime error: ", 109, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
int64_t nelua_tointeger_1(nlstring x, nlniltype base) {
  ...
  nelua_assert_line_70(ok, ((nlstring){(uint8_t*)"malformed integer", 17}));
  return i;
}
...
uintptr_t entropy_world_Storage_Vec2__create(entropy_world_Storage_Vec2__ptr self, entropy_math_vec2_Vec2 item) {
  if((nelua_vector_usize____len((&self->free)) > 0)) {
    ...
    nelua_assert_line_71(((*(uint16_t*)nelua_assert_deref(nelua_vector_uint16____atindex((&self->refs), id))) == 0), ((nlstring){(uint8_t*)"supposedly free id still has references!", 40}));
    ...
    nelua_assert_line_72((id == (nelua_vector_uint16____len((&self->refs)) - 1)), ((nlstring){(uint8_t*)"ids between refcount and data don't match up!", 45}));
    return (uintptr_t)id;
  }
}
...
entropy_math_vec2_Vec2_ptr entropy_world_Storage_Vec2____atindex(entropy_world_Storage_Vec2__ptr self, uintptr_t ptr) {
  nelua_assert_line_73(nelua_lt_nlusize_nlisize(ptr, nelua_vector_Vec2____len((&self->data))), ((nlstring){(uint8_t*)"invalid ptr!", 12}));
  nelua_assert_line_74(((*(uint16_t*)nelua_assert_deref(nelua_vector_uint16____atindex((&self->refs), ptr))) > 0), ((nlstring){(uint8_t*)"dead ptr!", 9}));
...
uintptr_t entropy_world_Storage_Vec2__1_create(entropy_world_Storage_Vec2__1_ptr self, entropy_math_vec2_Vec2 item) {
  if((nelua_vector_usize____len((&self->free)) > 0)) {
    uintptr_t id = nelua_vector_usize__pop((&self->free));
    nelua_assert_line_75(((*(uint16_t*)nelua_assert_deref(nelua_vector_uint16____atindex((&self->refs), id))) == 0), ((nlstring){(uint8_t*)"supposedly free id still has references!", 40}));
    (*(entropy_math_vec2_Vec2*)nelua_assert_deref(nelua_vector_Vec2____atindex((&self->data), id))) = item;
    (*(uint16_t*)nelua_assert_deref(nelua_vector_uint16____atindex((&self->refs), id))) = 1U;
    return id;
  } else {
    ...
    intptr_t id = (nelua_vector_Vec2____len((&self->data)) - 1);
    nelua_vector_uint16__push((&self->refs), 1U);
    nelua_assert_line_76((id == (nelua_vector_uint16____len((&self->refs)) - 1)), ((nlstring){(uint8_t*)"ids between refcount and data don't match up!", 45}));
    return (uintptr_t)id;
  }
}
...
entropy_math_vec2_Vec2_ptr entropy_world_Storage_Vec2__1___atindex(entropy_world_Storage_Vec2__1_ptr self, uintptr_t ptr) {
  nelua_assert_line_77(nelua_lt_nlusize_nlisize(ptr, nelua_vector_Vec2____len((&self->data))), ((nlstring){(uint8_t*)"invalid ptr!", 12}));
  nelua_assert_line_78(((*(uint16_t*)nelua_assert_deref(nelua_vector_uint16____atindex((&self->refs), ptr))) > 0), ((nlstring){(uint8_t*)"dead ptr!", 9}));
  return (&(*(entropy_math_vec2_Vec2*)nelua_assert_deref(nelua_vector_Vec2____atindex((&self->data), ptr))));
}
...
uintptr_t entropy_world_Storage_Entity__create(entropy_world_Storage_Entity__ptr self, main_Entity item) {
  if((nelua_vector_usize____len((&self->free)) > 0)) {
    uintptr_t id = nelua_vector_usize__pop((&self->free));
    nelua_assert_line_79(((*(uint16_t*)nelua_assert_deref(nelua_vector_uint16____atindex((&self->refs), id))) == 0), ((nlstring){(uint8_t*)"supposedly free id still has references!", 40}));
    ...
    nelua_vector_uint16__push((&self->refs), 1U);
    nelua_assert_line_80((id == (nelua_vector_uint16____len((&self->refs)) - 1)), ((nlstring){(uint8_t*)"ids between refcount and data don't match up!", 45}));
    return (uintptr_t)id;
  }
}
...
nlmulret_function_5WeuUYGDC1RF4e9JH_entropy_world_Storage_Entity__ptr_nlisize entropy_world_Storage_Entity____mpairs(entropy_world_Storage_Entity__ptr self) {
  return (nlmulret_function_5WeuUYGDC1RF4e9JH_entropy_world_Storage_Entity__ptr_nlisize){entropy_world_Storage_Entity____mnext, self, -1};
}
...
uintptr_t entropy_world_Storage_Mesh__create(entropy_world_Storage_Mesh__ptr self, entropy_scene_mesh_Mesh item) {
  if((nelua_vector_usize____len((&self->free)) > 0)) {
    uintptr_t id = nelua_vector_usize__pop((&self->free));
    nelua_assert_line_81(((*(uint16_t*)nelua_assert_deref(nelua_vector_uint16____atindex((&self->refs), id))) == 0), ((nlstring){(uint8_t*)"supposedly free id still has references!", 40}));
    ...
    nelua_vector_uint16__push((&self->refs), 1U);
    nelua_assert_line_82((id == (nelua_vector_uint16____len((&self->refs)) - 1)), ((nlstring){(uint8_t*)"ids between refcount and data don't match up!", 45}));
    return (uintptr_t)id;
  }
}
...
entropy_scene_mesh_Mesh_ptr entropy_world_Storage_Mesh____atindex(entropy_world_Storage_Mesh__ptr self, uintptr_t ptr) {
  nelua_assert_line_83(nelua_lt_nlusize_nlisize(ptr, nelua_vector_Mesh____len((&self->data))), ((nlstring){(uint8_t*)"invalid ptr!", 12}));
  nelua_assert_line_84(((*(uint16_t*)nelua_assert_deref(nelua_vector_uint16____atindex((&self->refs), ptr))) > 0), ((nlstring){(uint8_t*)"dead ptr!", 9}));
...
nlmulret_function_3GJ1mpt5YEiuRg5QG_entropy_world_Storage_Mesh__ptr_nlisize entropy_world_Storage_Mesh____mpairs(entropy_world_Storage_Mesh__ptr self) {
  return (nlmulret_function_3GJ1mpt5YEiuRg5QG_entropy_world_Storage_Mesh__ptr_nlisize){entropy_world_Storage_Mesh____mnext, self, -1};
}
...
uintptr_t entropy_world_Storage_Camera__create(entropy_world_Storage_Camera__ptr self, entropy_scene_camera_Camera item) {
  if((nelua_vector_usize____len((&self->free)) > 0)) {
    uintptr_t id = nelua_vector_usize__pop((&self->free));
    nelua_assert_line_85(((*(uint16_t*)nelua_assert_deref(nelua_vector_uint16____atindex((&self->refs), id))) == 0), ((nlstring){(uint8_t*)"supposedly free id still has references!", 40}));
    ...
    nelua_vector_uint16__push((&self->refs), 1U);
    nelua_assert_line_86((id == (nelua_vector_uint16____len((&self->refs)) - 1)), ((nlstring){(uint8_t*)"ids between refcount and data don't match up!", 45}));
    return (uintptr_t)id;
  }
}
...
entropy_scene_camera_Camera_ptr entropy_world_Storage_Camera____atindex(entropy_world_Storage_Camera__ptr self, uintptr_t ptr) {
  nelua_assert_line_87(nelua_lt_nlusize_nlisize(ptr, nelua_vector_Camera____len((&self->data))), ((nlstring){(uint8_t*)"invalid ptr!", 12}));
  nelua_assert_line_88(((*(uint16_t*)nelua_assert_deref(nelua_vector_uint16____atindex((&self->refs), ptr))) > 0), ((nlstring){(uint8_t*)"dead ptr!", 9}));
...
nlstring entropy_math_vec4_Vec4___tostring(entropy_math_vec4_Vec4_ptr self) {
  return nelua_nlstring___concat_7(((nlstring){(uint8_t*)"Vec4", 4}), nelua_nlstring___concat_7(((nlstring){(uint8_t*)"(", 1}), nelua_nlstring___concat_2(self->x, nelua_nlstring___concat_7(((nlstring){(uint8_t*)", ", 2}), nelua_nlstring___concat_2(self->y, nelua_nlstring___concat_7(((nlstring){(uint8_t*)", ", 2}), nelua_nlstring___concat_2(self->z, nelua_nlstring___concat_7(((nlstring){(uint8_t*)", ", 2}), nelua_nlstring___concat_2(self->w, ((nlstring){(uint8_t*)")", 1}))))))))));
}
...
nlstring entropy_math_mat4_Mat4___tostring(entropy_math_mat4_Mat4_ptr self) {
  entropy_math_mat4_Mat4 result = entropy_math_mat4_Mat4_transpose(self);
  return nelua_nlstring___concat_7(((nlstring){(uint8_t*)"Mat4", 4}), nelua_nlstring___concat_7(((nlstring){(uint8_t*)"(\n\t", 3}), nelua_nlstring___concat_4(result.x, nelua_nlstring___concat_7(((nlstring){(uint8_t*)",\n\t", 3}), nelua_nlstring___concat_4(result.y, nelua_nlstring___concat_7(((nlstring){(uint8_t*)",\n\t", 3}), nelua_nlstring___concat_4(result.z, nelua_nlstring___concat_7(((nlstring){(uint8_t*)",\n\t", 3}), nelua_nlstring___concat_4(result.w, ((nlstring){(uint8_t*)"\n)", 2}))))))))));
}
...
void nelua_assert_line_89(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/home/woze/projects/enqy/entropy/entropy/render/glfw_context.nelua:61:14: runtime error: ", 89, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
void entropy_render_glfw_context_GLFWContext_init(entropy_render_glfw_context_GLFWContext_ptr self, nlstring title, uint32_t width, uint32_t height, bool vsync) {
  ...
  nelua_assert_line_89((self->window != NULL), ((nlstring){(uint8_t*)"failed to create window!", 24}));
  self->width = width;
  self->height = height;
...
void entropy_render_glfw_context_GLFWContext_poll_events(entropy_render_glfw_context_GLFWContext_ptr self) {
  glfwPollEvents();
}
void entropy_render_renderer_RendererImplT_init(entropy_render_renderer_RendererImplT_ptr self, WGPUDeviceImpl_ptr device, WGPUTextureFormat target_format, uint32_t target_width, uint32_t target_height) {
  ...
  self->target_config = (record_Zrbw5J37uisrJoqq){.format = target_format, .width = target_width, .height = target_height};
...
nelua_filestream nelua_filestream__fromfp(FILE_ptr fp, function_2jryoGdNYpmXwuUqi closef) {
...
void nelua_assert_line_90(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/y9vnyq9wkbv0z22dgkjkzj09ss9l6wyk-nelua-9de66a3/lib/nelua/lib/filestream.nelua:93:19: runtime error: ", 111, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
nlmulret_nelua_filestream_nlstring_nlint64 nelua_filestream_open_1(nlstring filename, nlstring mode) {
  nelua_assert_line_90(nelua_checkmode(mode), ((nlstring){(uint8_t*)"invalid mode", 12}));
...
nlmulret_nlboolean_nlstring_nlint64 nelua_filestream_close(nelua_filestream_ptr self) {
  ...
  self->fs->closef = (function_4ZS7EgdsBbbg7Uzdz)NULL;
  if((res != 0)) {
    nlmulret_nlstring_nlint64 _ret_1 = nelua_geterrno_1();
...
void nelua_filestream_destroy(nelua_filestream_ptr self) {
  ...
  if((fs != NULL)) {
    ...
    nelua_GCAllocator_delete_2((&nelua_gc_allocator), self->fs);
  }
...
entropy_render_shader_Shader entropy_render_shader_Shader_load_from_file(nlstring name, nlstring path) {
  ...
  WGPUShaderModuleWGSLDescriptor_ptr wgsl_descriptor = nelua_GCAllocator_new_3((&nelua_gc_allocator), NELUA_NIL, NELUA_NIL, NELUA_NIL);
  wgsl_descriptor->chain.next = ((WGPUChainedStruct_ptr)NULL);
  wgsl_descriptor->chain.sType = 6;
  wgsl_descriptor->code = nelua_assert_string2cstring(nelua_filestream_read_1((&file), ((nlstring){(uint8_t*)"a", 1})).r1);
  nelua_filestream_close((&file));
  return (entropy_render_shader_Shader){.descriptor = {.nextInChain = ((WGPUChainedStruct_ptr)wgsl_descriptor), .label = nelua_assert_string2cstring(name)}};
}
...
void nelua_assert_line_91(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/y9vnyq9wkbv0z22dgkjkzj09ss9l6wyk-nelua-9de66a3/lib/nelua/lib/io.nelua:274:16: runtime error: ", 104, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
nlmulret_function_3za43wtfzNaFXZkKo_nelua_LinesState_nlstring_nelua_filestream nelua_io_lines_1(nlstring filename, nlniltype fmt) {
  nelua_filestream file = nelua_io_open_1(filename, NELUA_NIL).r1;
  nelua_assert_line_91(nelua_filestream_isopen((&file)), ((nlstring){(uint8_t*)"cannot open file", 16}));
  nlstring fmt_1 = ((nlstring){(uint8_t*)"l", 1});
  return (nlmulret_function_3za43wtfzNaFXZkKo_nelua_LinesState_nlstring_nelua_filestream){nelua_lines_next, (nelua_LinesState){.file = file, .fmt = fmt_1}, (nlstring){0}, file};
}
...
entropy_scene_mesh_Mesh entropy_scene_mesh_Mesh_load_from_obj(nlstring path) {
  ...
  {
    nlmulret_function_3za43wtfzNaFXZkKo_nelua_LinesState_nlstring_nelua_filestream _asgnret_1 = nelua_io_lines_1(path, NELUA_NIL);
    function_3za43wtfzNaFXZkKo __fornext = _asgnret_1.r1;
  ...
  {
    nlmulret_function_3za43wtfzNaFXZkKo_nelua_LinesState_nlstring_nelua_filestream _asgnret_4 = nelua_io_lines_1(path, NELUA_NIL);
    function_3za43wtfzNaFXZkKo __fornext = _asgnret_4.r1;
...
void entropy_render_impl_basic_Impl_init_1(entropy_render_impl_basic_Impl_ptr self, entropy_render_renderer_RendererImplT_ptr renderer) {
  entropy_render_shader_Shader vs_shader = entropy_render_shader_Shader_load_from_file(((nlstring){(uint8_t*)"basic vert shader", 17}), ((nlstring){(uint8_t*)"entropy/render/impl/basic/vert.wgsl", 35}));
  ...
  entropy_render_shader_Shader fs_shader = entropy_render_shader_Shader_load_from_file(((nlstring){(uint8_t*)"basic frag shader", 17}), ((nlstring){(uint8_t*)"entropy/render/impl/basic/frag.wgsl", 35}));
...
void entropy_render_impl_basic_Impl_render_1(entropy_render_impl_basic_Impl_ptr self, entropy_render_renderer_RendererImplT_ptr renderer, WGPURenderPassEncoderImpl_ptr pass, WGPUCommandEncoderImpl_ptr encoder, WGPUTextureViewImpl_ptr target, entropy_world_World_ptr world) {
  ...
  {
    nlmulret_function_3GJ1mpt5YEiuRg5QG_entropy_world_Storage_Mesh__ptr_nlisize _asgnret_1 = nelua_mpairs_2(meshes);
    function_3GJ1mpt5YEiuRg5QG __fornext = _asgnret_1.r1;
...
int nelua_main(int argc, char** argv) {
  ...
  {
    nlmulret_function_5WeuUYGDC1RF4e9JH_entropy_world_Storage_Entity__ptr_nlisize _asgnret_1 = nelua_mpairs_3(main_entities);
    function_5WeuUYGDC1RF4e9JH __fornext = _asgnret_1.r1;
  ...
  {
    nlmulret_function_5WeuUYGDC1RF4e9JH_entropy_world_Storage_Entity__ptr_nlisize _asgnret_3 = nelua_mpairs_3(main_entities);
    function_5WeuUYGDC1RF4e9JH __fornext = _asgnret_3.r1;
  ...
  {
    nlmulret_function_5WeuUYGDC1RF4e9JH_entropy_world_Storage_Entity__ptr_nlisize _asgnret_5 = nelua_mpairs_3(main_entities);
    function_5WeuUYGDC1RF4e9JH __fornext = _asgnret_5.r1;
  ...
  for(int64_t i = 0; i < 1000; i += 1) {
    main_now = nelua_os_now();
    {
      nlmulret_function_5WeuUYGDC1RF4e9JH_entropy_world_Storage_Entity__ptr_nlisize _asgnret_7 = nelua_mpairs_3(main_entities);
      function_5WeuUYGDC1RF4e9JH __fornext = _asgnret_7.r1;
  ...
  {
    nlmulret_function_4ujZU2iQ6roU5kmF_nelua_vector_float64__ptr_nlint64 _asgnret_9 = nelua_ipairs_1((&main_times));
    function_4ujZU2iQ6roU5kmF __fornext = _asgnret_9.r1;
  ...
  main_a = entropy_math_mat4_Mat4_identity();
  main_b = entropy_math_mat4_Mat4_identity();
  main_b.x.x = 2.0f;
  main_b.y.x = 2.0f;
  main_b.y.y = 2.0f;
  main_c = entropy_math_mat4_Mat4___mul(main_a, main_b);
  nelua_print_1(entropy_math_mat4_Mat4___tostring((&main_c)));
  wgpuSetLogCallback(main_anonfunc, NULL);
  wgpuSetLogLevel(3);
  nelua_require_entropy_render_impl_basic(NELUA_NIL);  nelua_require_entropy_scene_camera(NELUA_NIL);  nelua_require_entropy_scene_mesh_cached(NELUA_NIL);  entropy_render_glfw_context_GLFWContext_init((&main_context), ((nlstring){(uint8_t*)"testing", 7}), 512U, 512U, false);
  ...
  main_camera_idx = entropy_world_Storage_Camera__create(main_cameras, (entropy_scene_camera_Camera){.pos = {0.0f, 0.0f, 0.0f}, .rot = {0.0f, 0.0f, 0.0f}, .fov = 90.0f, .z_near = 0.1f, .z_far = 100.0f});
  ...
  main_mesh_idx = entropy_world_Storage_Mesh__create(main_meshes, entropy_scene_mesh_Mesh_load_from_obj(((nlstring){(uint8_t*)"./teapot.obj", 12})));
  entropy_scene_mesh_Mesh_prepare_1((&(*(entropy_scene_mesh_Mesh*)nelua_assert_deref(entropy_world_Storage_Mesh____atindex(main_meshes, main_mesh_idx)))), main_renderer);
  (*(entropy_scene_mesh_Mesh*)nelua_assert_deref(entropy_world_Storage_Mesh____atindex(main_meshes, main_mesh_idx))).transform = entropy_math_mat4_Mat4_identity();
  while((!entropy_render_glfw_context_GLFWContext_should_close((&main_context)))) {
    entropy_render_glfw_context_GLFWContext_poll_events((&main_context));
    (*(entropy_scene_camera_Camera*)nelua_assert_deref(entropy_world_Storage_Camera____atindex(main_cameras, main_camera_idx))).pos = (entropy_math_vec3_Vec3){(float)(nelua_math_sin_2(entropy_world_World_now((&main_world))) * 5), 2.0f, (float)(nelua_math_cos_2(entropy_world_World_now((&main_world))) * 5)};
    entropy_scene_camera_Camera_look_at((&(*(entropy_scene_camera_Camera*)nelua_assert_deref(entropy_world_Storage_Camera____atindex(main_cameras, main_camera_idx)))), (entropy_math_vec3_Vec3){0.0f, 1.0f, 0.0f});
